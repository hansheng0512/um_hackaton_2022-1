import {
	...
	Icon,
	useColorModeValue,
	createIcon, Center, HStack, VStack, VisuallyHidden,
...
export const LandingPage = () => {
	...
	const GridFeatures = Array.apply(null, Array(8)).map(function (x, i) {
		return {
			id: i,
	...
	const ThreeColumnFeature = ({ title, text, icon }) => {
		return (
			<Stack>
				<Flex
					w={16}
		...
		<>
			<Container maxW={'3xl'}>
				<Stack
					...
					<Text color={'gray.500'}>
						NO MORE MANUAL ANALYSIS, WE DO IT FOR YOU !
					</Text>
					<Stack
						direction={'column'}
						spacing={3}
