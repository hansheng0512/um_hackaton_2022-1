...
export const Forecast90Page = () => {
	...
	const kgbData = {
		...
		data: [
			{
				x: new Date(2002, 5, 24, 18, 30),
				y: [123.81, 6650.5, 6623.04, 6633.33]
			},
			{
				x: new Date(1538780400000),
				y: [123.01, 6643.59, 6620, 6630.11]
			},
			{
				x: new Date(1538782200000),
				y: [123.71, 6648.95, 6623.34, 6635.65]
			},
			{
				x: new Date(1538784000000),
				y: [13.65, 6651, 6629.67, 6638.24]
			},
			{
				x: new Date(1538785800000),
				y: [123.24, 6640, 6620, 6624.47]
			},
			{
				x: new Date(1538787600000),
				y: [123.53, 6636.03, 6621.68, 6624.31]
			},
			{
				x: new Date(1538789400000),
				y: [6624.61, 6632.2, 6617, 6626.02]
	...
	const onFinish = (values) => {
		...
		if (values.stockType === "OCNCASH") {
			setDataToShow(cashData)
		}

		if (values.stockType === "KGB") {
			setDataToShow(kgbData)
		}
	}
	...
	return (
		<MainLayout>
			<Space style={{ width: '100%' }} direction={"vertical"}>
				...
				{
					showChart && (
						<CandleStickChart data={dataToShow} />
					)
				}
			</Space>
		</MainLayout>
